...
import com.pereira.utils.ControlsExecutionParallelAgents;
...
public class TestRunner {
    ...
    public void testRunner() throws IOException {
        ...
        Results results = Runner.path("src/test/java/com/pereira")
                .tags("@solicitudExitosa200").outputCucumberJson(true).parallel(5);

        String karateOutputPath = "build/karate-reports";
        File karateReportsDir = new File(karateOutputPath);
        if (!karateReportsDir.exists()) {
            karateReportsDir.mkdirs();
        }
    ...
    static {
        System.setProperty("karate.ssl", "true"); // Ignora validación SSL en Karate
    }
}
